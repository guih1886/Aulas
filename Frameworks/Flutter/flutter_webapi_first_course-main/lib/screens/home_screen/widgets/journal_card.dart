...
import 'package:flutter_webapi_first_course/screens/common/ConfirmationDialog.dart';
...
class JournalCard extends StatelessWidget {
    ...
    Navigator.pushNamed(context, "add-journal", arguments: map).then((value) {
      ...
      if (value != null && value == true) {
        ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text("Journal adicionado com sucesso.")));
      } else if (value == false) {
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  deleteJournal(BuildContext context) {
    ...
    showConfirmationDialog(context,
            content:
                "Deseja mesmo remover o registro do dia ${WeekDay(journal!.createdAt.weekday).long}?")
        .then((value) {
      if (value) {
        if (journal != null) {
            ...
            (value) {
              ...
              if (value == true) {
                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                    content: Text("Journal deletado com sucesso.")));
              } else {
                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
